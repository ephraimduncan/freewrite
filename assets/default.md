...
2. Try to scroll on the timer using your mouse or trackpad — this is how you set different timer.
...
5. Click the clock on the bottom right to see your history. It's all saved locally in your browser.

See a bug? Wanna add something? See open issues and requests on the repo here:
https://github.com/ephraimduncan/freewrite

Wanna join your fellow writers? Join:
https://free.writer.so

This is a web port of the original macOS app by Farza:
